          ...
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex flex-col mt-10 font-firaCode md:w-1/2 w-full md:px-10 text-gray">
              <h1 className="text-white" data-aos="fade-right">
                Hello! I'm <span className="text-purple">Raj Vijay Jadhav</span>
                .
              </h1>
              <p className=" py-5 " data-aos="fade-up" data-aos-delay="50">
                I am a self-taught full-stack developer based in Mumbai, India.
                I can develop responsive websites from scratch and build them
                into dynamic, user-friendly web experiences.
              </p>
              <p className="" data-aos="fade-up" data-aos-delay="100">
                Transforming my creativity and knowledge into websites has been
                my passion for a few years. I have been assisting various
              ...
              <p className="py-5" data-aos="fade-up" data-aos-delay="150">
                Additionally, I studied React Native and created an application
                for the Smart India Hackathon, where our team won first place.
                In addition to programming, I also have hands-on IoT expertise.
              </p>
              <button
